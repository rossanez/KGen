...
class FactsExtractor:
    ...
    def extract_triples(self, input_filename, verbose=True):
    ...
    def __openie(self, input, output, verbose=True):
        nlp = CoreNLPFactory.createCoreNLP()

        with open(input, 'r') as input_file:
            contents = input_file.read()

        annotated = nlp.annotate(contents, properties={'annotators': 'tokenize, ssplit, pos, depparse, parse, openie', 'outputFormat': 'json'})
